...
urlpatterns = [
    ...
    path(
        "<int:pk>/<int:pkchapter>/create-story",
        CreateStoryContinuation.as_view(),
        name="create_story_cont",
    ),
    ...
    # api desde aca
    path("continuations-titles/<int:pk>", StoryContinuationsTitle.as_view(), name="conts_title_st"),
    path(
        "continuations-chapter-titles/<int:pk>",
        ChapterContinuationsTitle.as_view(),
        name="conts_title_chap",
    ),
