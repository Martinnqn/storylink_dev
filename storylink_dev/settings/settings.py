...
AZURE_B2C_APP_ID = env('AZURE_B2C_APP_ID')
AZURE_B2C_AUTHORITY = env('AZURE_B2C_AUTHORITY')
AZURE_B2C_APP_SECRET = env('AZURE_B2C_APP_SECRET')
AZURE_B2C_REDIRECT = env('AZURE_B2C_REDIRECT')
AZURE_B2C_SCOPES = env('AZURE_B2C_SCOPES')
AZURE_AD_AUTHORITY = env('AZURE_AD_AUTHORITY')
